...
the closest thing to hand. T13's own note had refused ``redact_label`` a place on the protocol on the same
...
def test_the_scan_rejects_a_member_the_protocol_does_not_declare(
    ...
    """Proved red: the shape `final_label` had -- public, on the class, in no contract."""
