...
**The store here is a second adapter, and that is what makes the seam real**. `AStore` holds
...
def test_an_engine_with_no_store_refuses_before_the_first_record() -> None:
    """A fact about the configuration, and a receipt for a write nobody made would be a lie."""
...
def test_the_stage_publishes_into_the_real_store(
    ...
    """One adapter is a hypothetical seam, and this is the test that makes it two.
