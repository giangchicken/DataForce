...
transaction open across the whole of it and a process that dies mid-run loses no committed write. The factory is what the composition root passes; the connection pool underneath it belongs to
